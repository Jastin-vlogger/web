      ...
      data.planned.forEach((plannedContainer) => {
        ...
        this.actualSplits.push(
          this.fb.group({
            ...
            commercialInvoiceDocumentUrl: [actualData?.commercialInvoiceDocumentUrl || ''],
            commercialInvoiceDocumentName: [actualData?.commercialInvoiceDocumentName || ''],
    ...
    actualContainers.forEach((actualData, shipmentIndex) => {
        ...
        this.documentationSplits.push(
          this.fb.group({
            ...
            daSubmittedToBankDate: [actualData?.daSubmittedToBankDate ? new Date(actualData.daSubmittedToBankDate) : null],
        ...
        this.arrivalTimeSplits.push(
          this.fb.group({
            ...
            doRemarks: [(actualData as any)?.doRemarks || ''],
        ...
        const containersArray = this.fb.array(
          Array.from({ length: storageContainerCount }, (_, c) => {
            ...
            return this.fb.group({
              ...
              shortageBags: [storageMatch?.shortageBags ?? 0],
  ...
  private createGroup(type: string, shipmentIndex = 0, containerCount = 1): FormGroup {
    switch (type) {
      ...
      case 'arrival':
        return this.fb.group({
          containerId: [null],
          commercialDocumentReceivedDate: [null],
